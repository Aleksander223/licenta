            ...
            {groups.map((x) => {
                return (
                    <Page style={styles.page}>
                        <Table data={partitionedData.get(x)}>
                            <TableHeader>
                                <TableCell
...
export default function Tokens() {
    ...
    useEffect(() => {
        axios
            .get("http://127.0.0.1:5000/tokens", {
                headers: {
                            ...
                            subHeaderComponent={
                                <div style={{ alignItems: "center" }}>
                                    <CSVLink
                                        ...
                                        filename={`tokens_${new Date().getTime()}.csv`}
                                    >
                                    ...
                                    <PDFDownloadLink
                                        document={generateDocument(data)}
                                        fileName={`tokens_${new Date().getTime()}.pdf`}
                                    >
                                        <Button className="mx-2 mb-3">
